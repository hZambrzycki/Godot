...
@onready var audio_activate : AudioStream = preload("res://Assets/Dungeon/lever-01.wav")
@onready var audio_deactivate : AudioStream = preload("res://Assets/Dungeon/lever-02.wav")
